    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data" id="registration">
            ...
            <div class="form-group">
                ...
                <span class="help-block" style="color:red;" ><?php echo $mrp_err; ?></span>
            </div>
            <!--<br><br>-->
            <div class="form-group">
                ...
                <span class="help-block" style="color:red;" ><?php echo $discount_err; ?></span>
            </div>
            <!--<br><br>-->
            <div class="form-group">
                <label for="tax">Tax Rate :</label>
                <input type="number" min="0" id="tax" placeholder="Tax Rate" name="tax" value="<?php echo $tax; ?>" required>
                <span class="help-block" style="color:red;" ><?php echo $tax_err; ?></span>
            </div>
            <!--<br><br>-->
            <div class="form-group">
            ...
            <div class="form-group">
                  ...
                  <span class="help-block" style="color:red;" ><?php echo $product_insert_err; ?></span>
              </div>
            <!--<br><br>-->
          </form>
        </div>
