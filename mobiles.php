<?php
  ...
  $sql_manufacturer = "SELECT DISTINCT MANUFACTURER FROM products WHERE PRODUCT_TYPE = 'MOBILE' ";
  ...
  $sql_RAM = "SELECT DISTINCT RAM_SIZE FROM products WHERE PRODUCT_TYPE = 'MOBILE'";
  $sql_RAM_err = "";
  ...
  $sql_HDD = "SELECT DISTINCT HDD_SIZE FROM products  WHERE PRODUCT_TYPE = 'MOBILE'";
  $sql_HDD_err = "";
  ...
  $sql_OS = "SELECT DISTINCT OS FROM products WHERE PRODUCT_TYPE = 'MOBILE'";
  $sql_OS_err = "";
  ...
  $sql_product_extract = "SELECT ID, MODEL, MRP_PRICE, DISCOUNT, IMAGE FROM products WHERE PRODUCT_TYPE = 'MOBILE'";
