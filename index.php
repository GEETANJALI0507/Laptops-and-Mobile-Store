    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
      ...
      <div id="mySidenav" class="sidenav">
        ...
        <div class="product_type">
          ...
          ?>
          <span class="help-block" style="display: block; margin-top: 5px; margin-bottom: 10px; color: red; font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; font-size: 14px;"><?php echo $product_type_err; ?></span>
        </div>
